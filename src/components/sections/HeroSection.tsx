...
const HeroSection = ({
  ...
  const successStories = [
    ...
    },
    {
      ...
      quote:
        "Instructor's teaching methods were very effective. He broke down complex maneuvers into simple, manageable steps, allowing me to grasp each concept at my own pace. His clear and concise instructions helped me understand the principles of safe driving, and he always ensured that I felt comfortable before moving on to the next skill.",
      emoji: "💪",
    ...
    },
    {
      ...
      actualImage: "https://imgur.com/UPRXaU3",
      achievement: "From Zero to Hero",
      quote:
        "I begin my driving lessons with no previous knowledge having zero hours of driving lessons or experience. Mamunur was also very flexible in the lesson times planned around my limited availability going above and beyond to cater to my needs.",
      emoji: "🏆",
              ...
              <div className="relative h-[400px] rounded-xl overflow-hidden shadow-2xl">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Actual Person Image (For Alexei and Alina) */}
                    {(activeSuccessStory === 2 || activeSuccessStory === 1) && (
                      <div className="absolute inset-0 flex items-center justify-center">
                        <img
                          src={successStories[activeSuccessStory].actualImage}
                          alt={successStories[activeSuccessStory].name}
                          className="w-full h-full object-cover"
                        />
                      </div>
