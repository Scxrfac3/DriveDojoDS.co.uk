    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center">
          <motion.div
            className="bg-gradient-to-br from-blue-500 to-purple-600 text-white font-bold text-xl p-2 rounded-full mr-2 shadow-lg"
          ...
          <motion.span
            className="ml-2 text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500"
            animate={{
